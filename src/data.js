module.exports = {
  ...
  selfPromoRulesMessage: {
    field: {
      ...
      content:
        "Your promotion will be removed if it:\n- Includes a description of 5 words or less\n- Does not include a link\n- Has been previously posted within a 24 hours time frame\n- Does not follow discord's TOS.",
    },
  },
  adDeletedMessage:
    'Your advertisement has been deleted because it does not follow our rules. This is an automatic action if you believe this was a mistake please contact the staff team',
